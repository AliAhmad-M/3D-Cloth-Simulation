...
static mu_Rect atlas[ATLAS_FONT + 128];

/* Helper function to construct a mu_Rect without compound literals */
...
static inline void mu_init_atlas() {
	atlas[MU_ICON_CLOSE] = rect(88, 68, 16, 16);
	atlas[MU_ICON_CHECK] = rect(0, 0, 18, 18);
	atlas[MU_ICON_EXPANDED] = rect(118, 68, 7, 5);
	atlas[MU_ICON_COLLAPSED] = rect(113, 68, 5, 7);
	atlas[ATLAS_WHITE] = rect(125, 68, 3, 3);

	atlas[ATLAS_FONT + 32] = rect(84, 68, 2, 17);
	atlas[ATLAS_FONT + 33] = rect(39, 68, 3, 17);
	atlas[ATLAS_FONT + 34] = rect(114, 51, 5, 17);
	atlas[ATLAS_FONT + 35] = rect(34, 17, 7, 17);
	atlas[ATLAS_FONT + 36] = rect(28, 34, 6, 17);
	atlas[ATLAS_FONT + 37] = rect(58, 0, 9, 17);
	atlas[ATLAS_FONT + 38] = rect(103, 0, 8, 17);
	atlas[ATLAS_FONT + 39] = rect(86, 68, 2, 17);
	atlas[ATLAS_FONT + 40] = rect(42, 68, 3, 17);
	atlas[ATLAS_FONT + 41] = rect(45, 68, 3, 17);
	atlas[ATLAS_FONT + 42] = rect(34, 34, 6, 17);
	atlas[ATLAS_FONT + 43] = rect(40, 34, 6, 17);
	atlas[ATLAS_FONT + 44] = rect(48, 68, 3, 17);
	atlas[ATLAS_FONT + 45] = rect(51, 68, 3, 17);
	atlas[ATLAS_FONT + 46] = rect(54, 68, 3, 17);
	atlas[ATLAS_FONT + 47] = rect(124, 34, 4, 17);
	atlas[ATLAS_FONT + 48] = rect(46, 34, 6, 17);
	atlas[ATLAS_FONT + 49] = rect(52, 34, 6, 17);
	atlas[ATLAS_FONT + 50] = rect(58, 34, 6, 17);
	atlas[ATLAS_FONT + 51] = rect(64, 34, 6, 17);
	atlas[ATLAS_FONT + 52] = rect(70, 34, 6, 17);
	atlas[ATLAS_FONT + 53] = rect(76, 34, 6, 17);
	atlas[ATLAS_FONT + 54] = rect(82, 34, 6, 17);
	atlas[ATLAS_FONT + 55] = rect(88, 34, 6, 17);
	atlas[ATLAS_FONT + 56] = rect(94, 34, 6, 17);
	atlas[ATLAS_FONT + 57] = rect(100, 34, 6, 17);
	atlas[ATLAS_FONT + 58] = rect(57, 68, 3, 17);
	atlas[ATLAS_FONT + 59] = rect(60, 68, 3, 17);
	atlas[ATLAS_FONT + 60] = rect(106, 34, 6, 17);
	atlas[ATLAS_FONT + 61] = rect(112, 34, 6, 17);
	atlas[ATLAS_FONT + 62] = rect(118, 34, 6, 17);
	atlas[ATLAS_FONT + 63] = rect(119, 51, 5, 17);
	atlas[ATLAS_FONT + 64] = rect(18, 0, 10, 17);
	atlas[ATLAS_FONT + 65] = rect(41, 17, 7, 17);
	atlas[ATLAS_FONT + 66] = rect(48, 17, 7, 17);
	atlas[ATLAS_FONT + 67] = rect(55, 17, 7, 17);
	atlas[ATLAS_FONT + 68] = rect(111, 0, 8, 17);
	atlas[ATLAS_FONT + 69] = rect(0, 35, 6, 17);
	atlas[ATLAS_FONT + 70] = rect(6, 35, 6, 17);
	atlas[ATLAS_FONT + 71] = rect(119, 0, 8, 17);
	atlas[ATLAS_FONT + 72] = rect(18, 17, 8, 17);
	atlas[ATLAS_FONT + 73] = rect(63, 68, 3, 17);
	atlas[ATLAS_FONT + 74] = rect(66, 68, 3, 17);
	atlas[ATLAS_FONT + 75] = rect(62, 17, 7, 17);
	atlas[ATLAS_FONT + 76] = rect(12, 51, 6, 17);
	atlas[ATLAS_FONT + 77] = rect(28, 0, 10, 17);
	atlas[ATLAS_FONT + 78] = rect(67, 0, 9, 17);
	atlas[ATLAS_FONT + 79] = rect(76, 0, 9, 17);
	atlas[ATLAS_FONT + 80] = rect(69, 17, 7, 17);
	atlas[ATLAS_FONT + 81] = rect(85, 0, 9, 17);
	atlas[ATLAS_FONT + 82] = rect(76, 17, 7, 17);
	atlas[ATLAS_FONT + 83] = rect(18, 51, 6, 17);
	atlas[ATLAS_FONT + 84] = rect(24, 51, 6, 17);
	atlas[ATLAS_FONT + 85] = rect(26, 17, 8, 17);
	atlas[ATLAS_FONT + 86] = rect(83, 17, 7, 17);
	atlas[ATLAS_FONT + 87] = rect(38, 0, 10, 17);
	atlas[ATLAS_FONT + 88] = rect(90, 17, 7, 17);
	atlas[ATLAS_FONT + 89] = rect(30, 51, 6, 17);
	atlas[ATLAS_FONT + 90] = rect(36, 51, 6, 17);
	atlas[ATLAS_FONT + 91] = rect(69, 68, 3, 17);
	atlas[ATLAS_FONT + 92] = rect(124, 51, 4, 17);
	atlas[ATLAS_FONT + 93] = rect(72, 68, 3, 17);
	atlas[ATLAS_FONT + 94] = rect(42, 51, 6, 17);
	atlas[ATLAS_FONT + 95] = rect(15, 68, 4, 17);
	atlas[ATLAS_FONT + 96] = rect(48, 51, 6, 17);
	atlas[ATLAS_FONT + 97] = rect(54, 51, 6, 17);
	atlas[ATLAS_FONT + 98] = rect(97, 17, 7, 17);
	atlas[ATLAS_FONT + 99] = rect(0, 52, 5, 17);
	atlas[ATLAS_FONT + 100] = rect(104, 17, 7, 17);
	atlas[ATLAS_FONT + 101] = rect(60, 51, 6, 17);
	atlas[ATLAS_FONT + 102] = rect(19, 68, 4, 17);
	atlas[ATLAS_FONT + 103] = rect(66, 51, 6, 17);
	atlas[ATLAS_FONT + 104] = rect(111, 17, 7, 17);
	atlas[ATLAS_FONT + 105] = rect(75, 68, 3, 17);
	atlas[ATLAS_FONT + 106] = rect(78, 68, 3, 17);
	atlas[ATLAS_FONT + 107] = rect(72, 51, 6, 17);
	atlas[ATLAS_FONT + 108] = rect(81, 68, 3, 17);
	atlas[ATLAS_FONT + 109] = rect(48, 0, 10, 17);
	atlas[ATLAS_FONT + 110] = rect(118, 17, 7, 17);
	atlas[ATLAS_FONT + 111] = rect(0, 18, 7, 17);
	atlas[ATLAS_FONT + 112] = rect(7, 18, 7, 17);
	atlas[ATLAS_FONT + 113] = rect(14, 34, 7, 17);
	atlas[ATLAS_FONT + 114] = rect(23, 68, 4, 17);
	atlas[ATLAS_FONT + 115] = rect(5, 52, 5, 17);
	atlas[ATLAS_FONT + 116] = rect(27, 68, 4, 17);
	atlas[ATLAS_FONT + 117] = rect(21, 34, 7, 17);
	atlas[ATLAS_FONT + 118] = rect(78, 51, 6, 17);
	atlas[ATLAS_FONT + 119] = rect(94, 0, 9, 17);
	atlas[ATLAS_FONT + 120] = rect(84, 51, 6, 17);
	atlas[ATLAS_FONT + 121] = rect(90, 51, 6, 17);
	atlas[ATLAS_FONT + 122] = rect(10, 68, 5, 17);
	atlas[ATLAS_FONT + 123] = rect(31, 68, 4, 17);
	atlas[ATLAS_FONT + 124] = rect(96, 51, 6, 17);
	atlas[ATLAS_FONT + 125] = rect(35, 68, 4, 17);
	atlas[ATLAS_FONT + 126] = rect(102, 51, 6, 17);
	atlas[ATLAS_FONT + 127] = rect(108, 51, 6, 17);
}